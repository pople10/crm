        ...
        "columns": [
            ...
            },
            {
                ...
                "render": function(data) {
                    ...
                    return '<button data-id="' + data.id + '" data-etat="' + data.etat + '" data-toggle="modal" data-animation="bounce" data-target=".commande-modal" type="button" class="btn btn-sm btn-success" style="float: none; margin: 5px;"><span class="fas fa-archive"></span> Détails</button>'+d+'<button data="" onclick="deleteCommande(' + data.id + ')" type="button" class="tabledit-delete-button btn btn-sm btn-info" style="float: none; margin: 5px;"><span class="ti-trash"></span></button>';
                }
            }
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        else
                        {
                            ...
                            $(".addsection").hide();
                            __ETAT__ = "Livrée";
                            $(".date_modal").html("<span class='badge badge-primary'>LIVRÉE</span> ");
                            fillCommandeTable(commande);
                            table.ajax.reload();
                            var MaxId;
