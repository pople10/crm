...
var getAllProducts = function(avoir) {
    ...
    /*$.ajax({
        ...
        type: 'POST',
        async: false,
        data: { op:"findAllByAvoir",avoir : avoir},
        success: function(result) {
            console.log(result);
...
var fillAvoirTable = function(_avoir) {
    ...
    $(".addsection").show();
    $.ajax({
        url: "../../../controller/AvoirAchatProduitController.php",
        type: 'POST',
        async: false,
...
var updateAvoir = function(id) {
    $.ajax({
        url: "../../../controller/AvoirAchatController.php",
        type: 'POST',
        async: false,
...
$(document).ready(function(){
            ...
            $.ajax({
                ...
                success: function(result) {
                    ...
                    if (typeof result == "string" && result.includes("error"))
                        ...
                        var last= $.ajax({url: "../../../controller/AvoirAchatController.php",async:false,type:"POST",data:{op:"lastID"}}).responseText;
    ...
    $(".btn-excel").click(function() {
        $("#avoir-table").tableHTMLExport({ type: 'csv', filename: 'Avoir - ' + $(".date_modal").text().replace("|", "") + $(".fournisseur_modal").text() + '.csv', ignoreColumns: '.buttons,.tabledit-toolbar-column' });
    });
