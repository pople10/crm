                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label for="code_input" class="col-sm-2 col-form-label">Code</label>
                                        <div class="col-sm-10">
                                            <input class="form-control form-control-sm" type="text" value=""
                                                id="code_input" name="code_input">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="libelle_input" class="col-sm-2 col-form-label">Libelle</label>
                                        <div class="col-sm-10">
                                            <input class="form-control form-control-sm" type="text" value=""
                                                id="libelle_input" name="libelle_input">
                                        </div>
                                    </div>
...
?>
<script src="../../script/categorie.js?r=<?php echo rand();?>" type="text/javascript"></script>