                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="siteweb_input" class="col-sm-4 col-form-label">Site
                                                    Web</label>
                                                <div class="col-sm-8">
                                                    <input class="form-control form-control-sm" type="url" value="" id="siteweb_input" name="siteweb_input">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="col-12">
                                            ...
                                            <div class="form-group row">
                                                <label for="note_textarea" class="col-sm-2 col-form-label">Note
                                                </label>
                                                <div class="col-sm-10">
                                                    <textarea id="note_textarea" class="form-control form-control-sm"
                                                              maxlength="225" rows="3" placeholder=""></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="text1_input" class="col-sm-2 col-form-label">Text
                                                    1</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control form-control-sm" type="url" value=""
                                                           id="text1_input" name="text1_input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="text2_input" class="col-sm-2 col-form-label">Text
                                                    2</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control form-control-sm" type="url" value=""
                                                           id="text2_input" name="text2_input">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="text3_input" class="col-sm-2 col-form-label">Text
                                                    3</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control form-control-sm" type=" url" value=""
                                                           id="text3_input" name="text3_input">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group row checkbox">
                                                        <div class="custom-control custom-checkbox mr-auto ml-auto">
                                                            ...
                                                            <label class="custom-control-label"
                                                                   for="clientdouteux_check">Fournisseur de charge</label>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-fournisseurs" class="table table-striped table-bordered w-100">
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nom</th>
...
<script src="../../script/fournisseur.js?r=<?php echo rand();?>" type="text/javascript"></script>