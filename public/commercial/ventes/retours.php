                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label for="client_select" class="col-sm-2 col-form-label">Fournisseur </label>
                                        <div class="col-sm-10">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="form-group col-md-3 quantite row">
                        <label for="quantite_input" class="col-sm-3 col-form-label"> Quantite <!--(<span id="quantitemax_span" class="text-danger"></span>)-->
                        </label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group col-md-3 remise row">
                        <label for="remise_input" class="col-sm-5 col-form-label"> Remise (<span id="remisemax_span" class="text-danger"></span>)
                        </label>
                        <div class="col-sm-7">
...
<script src="../../script/retoursvente.js?r=<?php echo rand();?>"></script>
