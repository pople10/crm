        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Devis Clients</h4>
                </div>
            </div>
        </div>
                    ...
                    <div class="card-body p-2">
                        <div class="btn-group">
                            <button type="button" class="btn btn-success btn-sm dropdown-toggle waves-effect"
                                data-toggle="dropdown" aria-expanded="false"> <i class="mdi mdi-account-plus"></i>
                                Nouveau <span class="caret"></span>
                            </button>
                            <div class="dropdown-menu">
                                <a class="dropdown-item nouveau_btn" href="#">Demande de prix</a>
                                <a class="dropdown-item nouveau_btn" href="#">Devis</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-devis" class="table table-striped table-bordered w-100">
                            <thead>
                                <tr>
                                    <th>Etat</th>
                                    <th>Devise N°</th>
...
<div class="modal fade devis-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="max-width: 1200px !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="preloader_modal" style="display: none;">
                    <div class="status_modal" style="display: none;">
                ...
                <div class="row addsection">
                    ...
                    <div class="form-group col-md-4 quantite row">
                        ...
                        <div class="col-sm-4">
                            <input class="form-control form-control-sm" id="quantite_input" name="quantite_input" type="number" min="1" value="0"
                ...
                <div class="row exportsection">
                    <div class="col-12 mb-2">
                        <div class="dt-buttons btn-group">
                            <a class="btn btn-secondary btn-excel buttons-html5" tabindex="0"
                                aria-controls="datatable-devis" href="#"><span>Excel</span></a>
...
<script src="../../script/devis_vente.js?r=<?php echo rand();?>" type="text/javascript"></script>