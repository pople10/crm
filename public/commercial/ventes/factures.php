...
?>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Factures clients</h4>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body p-2">
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item nouveau_btn" href="#">Facture</a>
                                    <a class="dropdown-item nouveau_btn" href="#">Avoir</a>
                                </div>-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="datatable-facture" class="table table-striped table-bordered w-100">
                                <thead>
                                <tr>
                                    <th>Etat</th>
                                    <th>Pièce N°</th>
    ...
    <div class="modal fade facture-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="row addsection">
                        ...
                        <div class="form-group col-md-4 quantite row">
                            <label for="quantite_input" class="col-sm-6 col-form-label"> Quantite <!--(<span id="quantitemax_span" class="text-danger"></span>)-->
                            </label>
                            <div class="col-sm-6">
                        ...
                        <div class="form-group col-md-4 remise row">
                            <label for="remise_input" class="col-sm-8 col-form-label"> Remise (<span id="remisemax_span" class="text-danger"></span>)
                            </label>
                            <div class="col-sm-4">
                        ...
                        <div class="col-12 mb-2">
                            <div class="dt-buttons exportsection btn-group">
                                <a class="btn btn-secondary btn-excel buttons-html5" tabindex="0"
                                   aria-controls="datatable-facture" href="#"><span>Excel</span></a>
...
<script src="../../script/facturevente.js?r=<?php echo rand();?>"></script>
