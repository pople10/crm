                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable-releves" class="table table-striped table-bordered w-100">
                            <thead>
                            <tr>
                                <th><input type="checkbox" class="" id="maincheck" data-parsley-multiple="groups" style="display: none;"  disabled></th>
                                <th></th>
                                <th>Etat</th>
                                <th>Date</th>
                                <th>Client</th>
...
<div class="modal fade paiment-modal" tabindex="-1"  role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    ...
    <script src="../../script/reglementsvente.js?r=<?php echo rand();?>"></script>
