    ...
    <div class="container-fluid">
                        ...
                        <form>
                            <div class="form-row">
                                <div class="col-12">
                                    ...
                                    <div class="form-group row">
                                        <label for="receptionner_input" class="col-sm-2 col-form-label">Réceptionnée par</label>
                                        <div class="col-sm-4">
                                            <input class="form-control form-control-sm" type="text" value=""
                                                id="receptionner_input" name="receptionner_input">
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <label for="commande_input" class="col-sm-2 col-form-label">N° Commande</label>
                                        <div class="col-sm-4">
                                            <div id="commande_input"></div>
                                        </div>
										<label for="bl_input" class="col-sm-2 col-form-label">N° BL interne </label>
                                        <div class="col-sm-4">
                                            <div id="bl_input"></div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="commande_date" class="col-sm-2 col-form-label">Date Commande</label>
                                        <div class="col-sm-4">
                                            <input class="form-control form-control-sm" type="date" value=""
                                                id="commande_date" name="commande_date" disabled>
                                        </div>
        ...
        <div class="row section2">
            <div class="col-12">
                <div class="card">
                    <div class="card-body p-2">
                        <button id="enregistrer_btn" t="0" class="btn btn-primary btn-sm ml-2 mr-2 float-right"
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="datatable-bon" class="table table-striped table-bordered w-100">
                            <thead>
                                <tr>
                                    <th>Etat</th>
                                    <th>Livraison N°</th>
...
<!-- end wrapper -->
    ...
    <div class="modal fade bon-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="max-width: 1200px !important;">
            <div class="modal-content">
                ...
                <div class="modal-body">
                        ...
                        <div class="col-12 mb-2">
                            <div class="dt-buttons exportsection btn-group">
                                <a class="btn btn-secondary btn-excel buttons-html5" tabindex="0"
                                   aria-controls="datatable-bon" href="#"><span>Excel</span></a>
                    ...
                    <table class="table" id="bon-table">
                        <thead>
                        <tr>
                            <th>Produit</th>
                            <th>Prix</th>
...
<script src="../../script/bonvente.js?r=<?php echo rand();?>"></script>
