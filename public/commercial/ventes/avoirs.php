    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Avoirs clients</h4>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <table id="datatable-avoir" class="table table-striped table-bordered w-100">
                            <thead>
                            <tr>
                                <th>Etat</th>
                                <th>Pièce N°</th>
...
<div class="modal fade avoir-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="row addsection">
                    ...
                    <div class="form-group col-md-5 prix row">
                        <label for="prix_input" class="col-sm-5 col-form-label"> Prix
                        </label>
                        <div class="col-sm-7">
                    ...
                    <div class="col-12 mb-2">
                        <div class="dt-buttons exportsection btn-group">
                            <a class="btn btn-secondary btn-excel buttons-html5" tabindex="0"
                               aria-controls="datatable-avoir" href="#"><span>Excel</span></a>
                ...
                <table class="table" id="avoir-table">
                    <thead>
                    <tr>
                        <th>Produit</th>
                        <th>Prix</th>
...
<script src="../../script/avoirvente.js?r=<?php echo rand();?>"></script>
