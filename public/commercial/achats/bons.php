                ...
                <div class="page-title-box">
                    <div class="btn-group pull-right">
                        ...
                        <li class="breadcrumb-item"><a href="<?php echo __ACHATSFOLDER__; ?>">Achats</a></li>
                            <li class="breadcrumb-item active">Bons de réception</li>
                        </ol>
                    </div>
                    <h4 class="page-title">Bons de réception</h4>
                </div>
            </div>
        </div>
...
<script src="../../script/bonachat.js?r=<?php echo rand();?>"></script>
