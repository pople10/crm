        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title">Devis fournisseurs</h4>
                </div>
            </div>
        </div>
                            ...
                            <div class="form-row">
                                <div class="col-12">
                                    <div class="form-group row">
                                        <label for="fournisseur_select" class="col-sm-2 col-form-label">Fournisseur
                                        </label>
                                        <div class="col-sm-10">
...
<script src="../../script/devis_achat.js?r=<?php echo rand(); ?>" type="text/javascript"></script>
